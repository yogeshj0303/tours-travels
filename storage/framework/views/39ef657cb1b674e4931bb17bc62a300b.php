<head>
    ...
    <meta charset="utf-8" />
    <title>Webcodian Tour And travel Dashboard</title>
...
<div id="removeNotificationModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="index.php">
                              <i class=" las la-home"></i> <span data-key="t-dashboards">Dashboard</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="home.php" class="nav-link menu-link collapsed">
                            <i class="mdi mdi-spin mdi-cog-outline fs-22"></i> <span data-key="t-Front CMS">Front CMS</span>
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="cab.php">
                            <i class=" las la-taxi"></i> <span data-key="t-Cab">Cab</span>
                            </a>
                        </li>
        ...
        <!-- Left Sidebar End -->
        <!-- Vertical Overlay-->
        <div class="vertical-overlay"></div><?php /**PATH C:\xampp\htdocs\tours-travels\resources\views/admin/include_admin/header.blade.php ENDPATH**/ ?>