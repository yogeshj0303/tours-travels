						...
						<div class="card mb-3">
							<div class="car-body px-xl-5 px-lg-4 py-lg-5 py-4 px-2">
								...
								<div class="text-center d-flex align-items-center justify-content-center">
									<a href="<?php echo e(url('/')); ?>" class="btn btn-md btn-light-seegreen fw-semibold mx-2">Book Next Tour</a>
...
<?php echo $__env->make('include.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tours-travels\resources\views/frontend/bookingpage-success.blade.php ENDPATH**/ ?>