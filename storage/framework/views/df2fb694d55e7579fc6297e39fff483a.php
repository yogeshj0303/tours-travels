    ...
    <button class="btn btn-info btn-sm" onclick="removeLastGuest()">Remove  Guest</button>
								...
								<div class="col-xl-12 col-lg-12 col-md-12">
									<div class="text-center d-flex align-items-center justify-content-center mt-4">
										...
										<a href="<?php echo e(url('bookingpage-03')); ?>" class="btn btn-md btn-primary fw-semibold mx-2">Make Your Payment<i
...
<?php echo $__env->make('include.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tours-travels\resources\views/frontend/bookingpage-02.blade.php ENDPATH**/ ?>