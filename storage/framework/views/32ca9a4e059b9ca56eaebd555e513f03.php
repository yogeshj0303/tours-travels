					...
					<div class="col-xl-7 col-lg-9 col-md-12">
						...
						<div class="fpc-capstion text-center my-4">
							<div class="fpc-captions">
								<h1 class="xl-heading text-light">Hotels Details</h1>
								...
								<div class="row align-items-center justify-content-between">
									<div class="col-xl-8 col-lg-7 col-md-12">
										<div class="galleryGrid typeGrid_2 mb-lg-0 mb-3">
											<div class="galleryGrid__item relative d-flex">
												<a href="assets/img/car.jpg" data-lightbox="roadtrip"><img src="assets/img/hotel/hotel1.jpg"
									...
									<div class="col-xl-4 col-lg-5 col-md-12">
										<div class="card border br-dashed">
											...
											<div class="card-body">
												<div class="d-block mb-3">
													<div class="d-flex align-items-center justify-content-start">
														<div class="text-dark fw-bold fs-3 me-2">Rs175</div>
												...
												<div class="d-block">
													...
													<div class="form-group">
														...
														<input type="text" class="form-control" value="20-03-2024">
													</div>

													<div class="form-group mb-4">
														<label class="form-label">Check-Out</label>
														<input type="text" class="form-control" value="23-03-2024">
													</div>

                                                    <div class="form-group mb-4">
														<label class="form-label">Member</label>
														<input type="text" class="form-control" value="2 Adult 1 Child">
													</div>

                                                    <div class="form-group mb-4">
														<label class="form-label">Room</label>
														<input type="text" class="form-control" value="1 Room">
													</div>
											...
											<a href="booking-page.php" class="btn btn-sm btn-primary full-width fw-medium text-uppercase mb-2"
...
<?php echo $__env->make('include.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tours-travels\resources\views/frontend/hotel-detail.blade.php ENDPATH**/ ?>