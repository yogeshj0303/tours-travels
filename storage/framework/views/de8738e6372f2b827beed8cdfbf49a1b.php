					...
					<div class="col-xl-7 col-lg-9 col-md-12">
						...
						<div class="fpc-capstion text-center my-4">
							<div class="fpc-captions">
								<h1 class="xl-heading text-light">Cab Details</h1>
											...
											<div class="card-body">
												...
												<div class="d-block">
													...
													<div class="form-group">
														...
														<input type="text" class="form-control" value="Bhu Lanka Varanasi">
													</div>

													<div class="form-group mb-4">
														<label class="form-label">Drop Address</label>
														<input type="text" class="form-control" value="Assi Ghat Varanasi">
													</div>
...
<?php echo $__env->make('include.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tours-travels\resources\views/frontend/cardetail.blade.php ENDPATH**/ ?>