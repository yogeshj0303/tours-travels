							...
							<div class="col-xl-12 col-lg-12 col-md-12">
								<div class="card list-layout-block rounded-3 p-3">
									<div class="row">
										...
										<a href="<?php echo e(url('hotel-detail')); ?>">
										...
										<div
											...
											<div class="position-relative mt-auto full-width">
												...
												<div class="d-flex align-items-start align-items-md-end text-start text-md-end flex-row">
													...
													<a href="<?php echo e(url('booking-page')); ?>" class="btn btn-md btn-primary full-width fw-medium px-lg-4">Book Now<i
...
<?php echo $__env->make('include.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tours-travels\resources\views/frontend/hotel.blade.php ENDPATH**/ ?>