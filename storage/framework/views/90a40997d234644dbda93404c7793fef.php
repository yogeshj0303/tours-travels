...
<script>
    $(document).ready(function() {
        $('#contactForm').submit(function(event) {
            ...
            $.ajax({
                url: "<?php echo e(route('submit.contact')); ?>",
                type: 'POST',
                data: formData,
                headers: {
...
<?php echo $__env->make('include.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tours-travels\resources\views/frontend/contact.blade.php ENDPATH**/ ?>