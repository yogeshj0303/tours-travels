				...
				<nav id="navigation" class="navigation navigation-landscape">
					...
					<div class="nav-menus-wrapper" style="transition-property: none;">
						...
						<ul class="nav-menu">
							...
							<li><a href="<?php echo e(url('/')); ?>">Home<span class="submenu-indicator"></span></a>
								
							</li>
                            <li><a href="<?php echo e(url('about')); ?>">About Us<span class="submenu-indicator"></span></a>
								
							</li>

                            <li><a href="<?php echo e(url('destination')); ?>">India Tour<span class="submenu-indicator"></span></a>
								
							</li>

                            <li><a href="<?php echo e(url('car')); ?>">Tourist Transport Service<span class="submenu-indicator"></span></a>
							...
							<li><a href="<?php echo e(url('hotel')); ?>">Hotel<span class="submenu-indicator"></span></a>
								
							</li>

						
                        	<li><a href="<?php echo e(url('blog')); ?>">Blog<span class="submenu-indicator"></span></a>
							...
							<li class=""><a href="#">Gallery</span></a>
								<ul class="nav-dropdown nav-submenu" style="right: auto; display: none;">
									<li class="">
										<a href="<?php echo e(url('Photo')); ?>">Photo Gallery</a>
									</li>
									<li>
										<a href="<?php echo e(url('Video')); ?>">Video Gallery</a>
									</li>
    ...
    <?php if(session()->has('customer_id')): ?>
		...
		<div class="dropdown">
                <a class="dropdown-toggle" href="#" role="button" id="customerDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                    <i class="fa-regular fa-user fs-6 me-2"></i><?php echo e($customer->name); ?>

                </a>
                <ul class="dropdown-menu" aria-labelledby="customerDropdown">
                    <li><a class="dropdown-item" href="#">Profile</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li> <a class="dropdown-item" href="<?php echo e(route('front-logout')); ?>">Logout</a></li>
                </ul>
            </div>
      
    <?php else: ?>
        <a href="<?php echo e(url('front-login')); ?>"><i class="fa-regular fa-user fs-6 me-2"></i>Login</a>
		<?php endif; ?>
</li>
		...
		<!-- End Navigation -->
		<div class="clearfix"></div><?php /**PATH C:\xampp\htdocs\tours-travels\resources\views/include/header.blade.php ENDPATH**/ ?>