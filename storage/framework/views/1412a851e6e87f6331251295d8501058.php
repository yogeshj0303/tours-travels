					...
					<div class="col-xl-7 col-lg-9 col-md-12">
						...
						<div class="fpc-capstion text-center my-4">
							<div class="fpc-captions">
								<h1 class="xl-heading text-light">Video Details</h1>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
						<div class="blogGrid-wrap d-flex flex-column h-100">
							<div class="blogGrid-pics">
								<a href="<?php echo e(url('video-detail')); ?>" class="d-block"><img src="assets/img/blog-1.jpg" class="img-fluid rounded" alt="Blog image"></a>
							</div>
							<div class="blogGrid-caps pt-3">
								
								<h4 class="fw-bold fs-6 lh-base"><a href="<?php echo e(url('video-detail')); ?>" class="text-dark">VARANASI</a></h4>
...
<?php echo $__env->make('include.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tours-travels\resources\views/frontend/video.blade.php ENDPATH**/ ?>