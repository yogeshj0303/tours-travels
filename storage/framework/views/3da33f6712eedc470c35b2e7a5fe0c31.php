				...
				<div class="row align-items-center">
					...
					<div class="col-xl-12 col-lg-12 col-md-12">
						<div class="text-center d-flex align-items-center justify-content-center mt-4">
							...
							<a href="<?php echo e(url('bookingpage-success')); ?>" class="btn btn-md btn-primary fw-semibold mx-2">Pay Now<i
...
<?php echo $__env->make('include.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tours-travels\resources\views/frontend/bookingpage-03.blade.php ENDPATH**/ ?>