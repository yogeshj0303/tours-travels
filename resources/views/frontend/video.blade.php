					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
						<div class="blogGrid-wrap d-flex flex-column h-100">
							<div class="blogGrid-pics">
								<a href="{{url('video-detail')}}" class="d-block"><img src="assets/img/blog-1.jpg" class="img-fluid rounded" alt="Blog image"></a>
							</div>
							<div class="blogGrid-caps pt-3">
								
								<h4 class="fw-bold fs-6 lh-base"><a href="{{url('video-detail')}}" class="text-dark">VARANASI</a></h4>
