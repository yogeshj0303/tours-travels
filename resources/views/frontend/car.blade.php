    ...
    <div class="py-5 bg-primary position-relative my-3">
		...
		<section class="gray-simple">
			<div class="container-fluid">
				<div class="row justify-content-between gy-4 gx-lg-3 gx-md-3 gx-4">
					...
					<div class="col-lg-3 col-md-12">
						<div class="filter-searchBar bg-white rounded-3">
							...
							<div class="filter-searchBar-body">
								...
								<div class="searchBar-single px-3 py-3">
									<div class="searchBar-single-title d-flex align-items-center justify-content-between mb-3">
										<h6 class="sidebar-subTitle fs-6 fw-medium m-0">Rquire Seets</h6>
										<a href="#" class="text-md fw-medium text-muted active">Reset</a>
									</div>
									<div class="searchBar-single-wrap">
										<ul class="row align-items-center justify-content-between p-0 gx-3 gy-2 mb-0">
													...
													<div class="frm-slicing d-flex align-items-center">
														...
														<div
															...
															<div class="frms-flex d-flex align-items-center">
																...
																<div class="frm-slicing-title ps-2"><span class="text-muted-2">2 seeters</span></div>
															</div>
															<div class="text-end"><span class="text-md text-muted-2 opacity-75">Rs 390.00</span></div>
														</div>
													</div>
													...
													<div class="frm-slicing d-flex align-items-center">
														...
														<div
															...
															<div class="frms-flex d-flex align-items-center">
																...
																<div class="frm-slicing-title ps-2"><span class="text-muted-2"> 4 seeters</span>
																</div>
															</div>
															<div class="text-end"><span class="text-md text-muted-2 opacity-75">Rs 310.00</span></div>
														</div>
													</div>
													...
													<div class="frm-slicing d-flex align-items-center">
														...
														<div
															...
															<div class="frms-flex d-flex align-items-center">
																...
																<div class="frm-slicing-title ps-2"><span class="text-muted-2">6 seeters</span></div>
															</div>
															<div class="text-end"><span class="text-md text-muted-2 opacity-75">Rs 390.00</span></div>
														</div>
													</div>
													...
													<div class="frm-slicing d-flex align-items-center">
														...
														<div
															...
															<div class="frms-flex d-flex align-items-center">
																...
																<div class="frm-slicing-title ps-2"><span class="text-muted-2">8 seeters</span></div>
															</div>
															<div class="text-end"><span class="text-md text-muted-2 opacity-75">Rs410.00</span></div>
														</div>
													</div>
													...
													<div class="frm-slicing d-flex align-items-center">
														...
														<div
															...
															<div class="frms-flex d-flex align-items-center">
																...
																<div class="frm-slicing-title ps-2"><span class="text-muted-2">10 seeters</span></div>
															</div>
															<div class="text-end"><span class="text-md text-muted-2 opacity-75">Rs 370.00</span></div>
														</div>
													</div>
										...
										<div class="col-xl col-lg col-md">
											<div class="listLayout_midCaps mt-md-0 mt-3 mb-md-0 mb-3">
												...
												<div class="position-relative mt-3">
													<div class="fw-medium text-dark">600Kms included. After that Rs15/Kms</div>
													<div class="text-md text-muted">Free waiting up to 45 minutes</div>
                                                    <a href="{{url('cardetail')}}" class="text-md text-dark">Read More</a>
												</div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12">
								<div class="card list-layout-block rounded-3 p-3">
									<div class="row">
										...
										<a href="{{url('cardetail')}}">
											<div class="cardImage__caps rounded-2 overflow-hidden h-100">
												<img class="img-fluid h-100 object-fit" src="assets/img/swift-big@2x.jpg" alt="image">
											</div></a>
										</div>

										<div class="col-xl col-lg col-md">
											<div class="listLayout_midCaps mt-md-0 mt-3 mb-md-0 mb-3">
												<h4 class="fs-5 fw-bold mb-1">Swift New</h4>
												<ul class="row g-2 p-0">
													<li class="col-auto">
														<p class="text-muted-2 text-md">SUV</p>
													</li>
