...
<!-- Mirrored from themezhub.net/geotrip-live/geotrip/slider-home.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Jan 2024 08:21:34 GMT -->
...
@section('content')
		...
		<div id="myCarousel" class="carousel slide carousel-fade mb-6">
			<div class="carousel-inner">
				...
				<div class="carousel-item active bg-cover" style="background:url(assets/img/Home.jpg)no-repeat;" data-overlay="6">
					<div class="container">
				...
				<div class="carousel-item bg-cover" style="background:url(assets/img/banner3.jpg)no-repeat;" data-overlay="6">
					<div class="container">
						<div class="carousel-caption">
				...
				<div class="carousel-item bg-cover" style="background:url(assets/img/banner2.jpg)no-repeat;" data-overlay="6">
					<div class="container">
						<div class="carousel-caption">
				...
				<div class="row align-items-center justify-content-between g-4">
					...
					<div class="col-xl-6 col-lg-6 col-md-6">
						<div class="">
							...
							<p class="text-justify">In a professional context it often happens that private or corporate clients corder a publication to be
					...
					<div class="col-xl-5 col-lg-6 col-md-6">
						<div class="position-relative">
							<img src="assets/img/india-attraction.webp" class="img-fluid" alt="">
						</div>
					</div>
				...
				<div class="row align-items-center justify-content-center">
					<div class="col-xl-8 col-lg-9 col-md-11 col-sm-12">
						<div class="secHeading-wrap text-center mb-5">
							<h2>INDIA TOUR</h2>
							<p>Find Perfect Holiday Destination.</p>
						</div>
					</div>
				</div>
					...
					<div class="col-xl-12 col-lg-12 col-md-12">
						<div class="main-carousel cols-4 dots-full">
							...
							<div class="carousel-cell">
								<div class="cardCities cursor rounded-2">
									<div class="cardCities-image ratio ratio-4">
										<img src="	https://www.traveltoindia.org/images/cover9.webp" class="img-fluid object-fit" alt="image">
									</div>
									...
									<div class="citiesCard-content d-flex flex-column justify-content-between text-center px-4 py-4">
										...
										<div class="citiesCard-bottomcaps">
											<h4 class="text-light fs-3 mb-3">East India</h4>
											<a href="{{url('bookingpage-02')}}" class="btn btn-whitener full-width fw-medium">Book Now<i
							...
							<div class="carousel-cell">
								<div class="cardCities cursor rounded-2">
									<div class="cardCities-image ratio ratio-4">
										<img src="https://www.traveltoindia.org/images/west-india1.webp" class="img-fluid object-fit" alt="image">
									</div>
									...
									<div class="citiesCard-content d-flex flex-column justify-content-between text-center px-4 py-4">
										...
										<div class="citiesCard-bottomcaps">
											<h4 class="text-light fs-3 mb-3">West India</h4>
											<a href="{{url('bookingpage-02')}}" class="btn btn-whitener full-width fw-medium">Book Now<i
													class="fa-solid fa-arrow-trend-up ms-2"></i></a>
										</div>
									</div>
							...
							<div class="carousel-cell">
								<div class="cardCities cursor rounded-2">
									<div class="cardCities-image ratio ratio-4">
										<img src="	https://www.traveltoindia.org/images/11340816025_996b5ed143_z.webp" class="img-fluid object-fit" alt="image">
									</div>
									...
									<div class="citiesCard-content d-flex flex-column justify-content-between text-center px-4 py-4">
										...
										<div class="citiesCard-bottomcaps">
											<h4 class="text-light fs-3 mb-3">Nort India</h4>
											<a href="{{url('bookingpage-02')}}" class="btn btn-whitener full-width fw-medium">Book Now<i
													class="fa-solid fa-arrow-trend-up ms-2"></i></a>
										</div>
									</div>
							...
							<div class="carousel-cell">
								<div class="cardCities cursor rounded-2">
									<div class="cardCities-image ratio ratio-4">
										<img src="https://www.traveltoindia.org/images/kerala.webp" class="img-fluid object-fit" alt="image">
									</div>
									...
									<div class="citiesCard-content d-flex flex-column justify-content-between text-center px-4 py-4">
										...
										<div class="citiesCard-bottomcaps">
											<h4 class="text-light fs-3 mb-3">South India</h4>
											<a href="{{url('bookingpage-02')}}" class="btn btn-whitener full-width fw-medium">Book Now<i
													class="fa-solid fa-arrow-trend-up ms-2"></i></a>
										</div>
									</div>
							...
							<div class="carousel-cell">
								<div class="cardCities cursor rounded-2">
									<div class="cardCities-image ratio ratio-4">
										<img src="	https://www.traveltoindia.org/images/mp-home1.webp" class="img-fluid object-fit" alt="image">
									</div>
									...
									<div class="citiesCard-content d-flex flex-column justify-content-between text-center px-4 py-4">
										...
										<div class="citiesCard-bottomcaps">
											<h4 class="text-light fs-3 mb-3">Central India</h4>
											<a href="{{url('bookingpage-02')}}" class="btn btn-whitener full-width fw-medium">Book Now<i
													class="fa-solid fa-arrow-trend-up ms-2"></i></a>
										</div>
									</div>
							...
							<div class="carousel-cell">
								<div class="cardCities cursor rounded-2">
									<div class="cardCities-image ratio ratio-4">
										<img src="https://www.traveltoindia.org/images/destination/gt2.webp" class="img-fluid object-fit" alt="image">
									</div>
									...
									<div class="citiesCard-content d-flex flex-column justify-content-between text-center px-4 py-4">
										...
										<div class="citiesCard-bottomcaps">
											<h4 class="text-light fs-3 mb-3">Golden Temple</h4>
											<a href="{{url('bookingpage-02')}}" class="btn btn-whitener full-width fw-medium">Book Now<i
													class="fa-solid fa-arrow-trend-up ms-2"></i></a>
										</div>
									</div>
							...
							<div class="carousel-cell">
								<div class="cardCities cursor rounded-2">
									<div class="cardCities-image ratio ratio-4">
										<img src="https://www.traveltoindia.org/images/destination/popular-exotic-rajasthan-tours.webp" class="img-fluid object-fit" alt="image">
									</div>
									...
									<div class="citiesCard-content d-flex flex-column justify-content-between text-center px-4 py-4">
										...
										<div class="citiesCard-bottomcaps">
											<h4 class="text-light fs-3 mb-3">Rajsthan</h4>
											<a href="{{url('bookingpage-02')}}" class="btn btn-whitener full-width fw-medium">Book Now<i
													class="fa-solid fa-arrow-trend-up ms-2"></i></a>
										</div>
									</div>
				...
				<div class="row justify-content-center gy-4 gx-xl-3 gx-lg-4 gx-4">
					...
					<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
						<div class="pop-touritem">
							<a href="{{url('destinationdetail')}}" class="card rounded-3 border br-dashed m-0">
								<div class="flight-thumb-wrapper p-2 pb-0">
									<div class="popFlights-item-overHidden rounded-3">
										<img src="assets/img/attr/5c.jpg" class="img-fluid" alt="">
									</div>
								</div>
					...
					<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
						<div class="pop-touritem">
							<a href="{{url('destinationdetail')}}" class="card rounded-3 border br-dashed m-0">
								<div class="flight-thumb-wrapper p-2 pb-0">
									<div class="popFlights-item-overHidden rounded-3">
										<img src="assets/img/attr/SOU.jpg" class="img-fluid" alt="">
									</div>
								</div>
								<div class="touritem-middle position-relative p-3">
									<div class="touritem-flexxer">
					...
					<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
						<div class="pop-touritem">
							<a href="{{url('destinationdetail')}}" class="card rounded-3 border br-dashed m-0">
								<div class="flight-thumb-wrapper p-2 pb-0">
									<div class="popFlights-item-overHidden rounded-3">
										<img src="assets/img/attr/goa.jpg" class="img-fluid" alt="">
									</div>
								</div>
								<div class="touritem-middle position-relative p-3">
									<div class="touritem-flexxer">
        ...
        <section>
			<div class="container">
				...
				<div class="row align-items-center justify-content-center">
					<div class="col-xl-8 col-lg-9 col-md-11 col-sm-12">
						<div class="secHeading-wrap text-center mb-5">
							<h2>HOTELS FOR STAYING</h2>
							<p>Find Perfect Staying Place.</p>
						</div>
					</div>
				</div>
					...
					<div class="col-xl-12 col-lg-12 col-md-12">
						<div class="main-carousel cols-4 dots-full">
							...
							<div class="carousel-cell">
								<div class="cardCities cursor rounded-2">
									<div class="cardCities-image ratio ratio-4">
										<img src="assets/img/hotel/hotel1.jpg" class="img-fluid object-fit" alt="image">
									</div>
									...
									<div class="citiesCard-content d-flex flex-column justify-content-between text-center px-4 py-4">
										...
										<div class="citiesCard-bottomcaps">
											<h4 class="text-light fs-3 mb-3">hotel varansi</h4>
											<a href="{{url('hotel')}}" class="btn btn-whitener full-width fw-medium">Explore Now<i
													class="fa-solid fa-arrow-trend-up ms-2"></i></a>
										</div>
									</div>
								</div>
							...
							<div class="carousel-cell">
								<div class="cardCities cursor rounded-2">
									...
									<div class="citiesCard-content d-flex flex-column justify-content-between text-center px-4 py-4">
										...
										<div class="citiesCard-bottomcaps">
											<h4 class="text-light fs-3 mb-3">Hotel in Lucknow</h4>
											<a href="{{url('hotel')}}" class="btn btn-whitener full-width fw-medium">Explore Now<i
													class="fa-solid fa-arrow-trend-up ms-2"></i></a>
										</div>
									</div>
							...
							<div class="carousel-cell">
								<div class="cardCities cursor rounded-2">
									...
									<div class="citiesCard-content d-flex flex-column justify-content-between text-center px-4 py-4">
										...
										<div class="citiesCard-bottomcaps">
											<h4 class="text-light fs-3 mb-3">Hotel In Mumbai</h4>
											<a href="{{url('hotel')}}" class="btn btn-whitener full-width fw-medium">Explore Now<i
													class="fa-solid fa-arrow-trend-up ms-2"></i></a>
										</div>
									</div>
							...
							<div class="carousel-cell">
								<div class="cardCities cursor rounded-2">
									...
									<div class="citiesCard-content d-flex flex-column justify-content-between text-center px-4 py-4">
										...
										<div class="citiesCard-bottomcaps">
											<h4 class="text-light fs-3 mb-3">Hotel In Kerala</h4>
											<a href="{{url('hotel')}}" class="btn btn-whitener full-width fw-medium">Explore Now<i
													class="fa-solid fa-arrow-trend-up ms-2"></i></a>
										</div>
									</div>
							...
							<div class="carousel-cell">
								<div class="cardCities cursor rounded-2">
									...
									<div class="citiesCard-content d-flex flex-column justify-content-between text-center px-4 py-4">
										...
										<div class="citiesCard-bottomcaps">
											<h4 class="text-light fs-3 mb-3">Hotel In Delhi</h4>
											<a href="{{url('hotel')}}" class="btn btn-whitener full-width fw-medium">Explore Now<i
													class="fa-solid fa-arrow-trend-up ms-2"></i></a>
										</div>
									</div>
							...
							<div class="carousel-cell">
								<div class="cardCities cursor rounded-2">
									...
									<div class="citiesCard-content d-flex flex-column justify-content-between text-center px-4 py-4">
										...
										<div class="citiesCard-bottomcaps">
											<h4 class="text-light fs-3 mb-3">Hotel in Jammu Kasmir</h4>
											<a href="{{url('hotel')}}" class="btn btn-whitener full-width fw-medium">Explore Now<i
													class="fa-solid fa-arrow-trend-up ms-2"></i></a>
										</div>
									</div>
							...
							<div class="carousel-cell">
								<div class="cardCities cursor rounded-2">
									...
									<div class="citiesCard-content d-flex flex-column justify-content-between text-center px-4 py-4">
										...
										<div class="citiesCard-bottomcaps">
											<h4 class="text-light fs-3 mb-3"> Hotel In Rajsthan</h4>
											<a href="{{url('hotel')}}" class="btn btn-whitener full-width fw-medium">Explore Now<i
													class="fa-solid fa-arrow-trend-up ms-2"></i></a>
										</div>
									</div>
		...
		<section class="gray-simple">
			<div class="container">
				...
				<div class="row align-items-center justify-content-center">
					<div class="col-xl-8 col-lg-9 col-md-11 col-sm-12">
						<div class="secHeading-wrap text-center mb-5">
							<h2>Tourist Transport Service</h2>
							<p>We are best Transport rental company in India.</p>
						</div>
					</div>
				</div>
							...
							<div class="card rounded-3 border m-0">
								<div class="flight-thumb-wrapper">
									<div class="popFlights-item-overHidden">
										<img src="assets/img/tempo_bnr-2.webp" class="img-fluid" alt="">
									</div>
								</div>
								<div class="touritem-middle position-relative p-3">
									<div class="touritem-flexxer">
										...
										<div class="detail ellipsis-container mt-2">
											<p class="m-0 text-md">We are best luxury van rental company in India offering van rental & luxury car on rent services all over India. Our vision is to.</p>
										</div>
										
									</div>
									<div class="booking-wrapes d-flex align-items-center mt-3">
										<a href="{{url('bookingpage-02')}}"class="btn btn-md btn-light-primary fw-medium rounded full-width me-2">Request Book<i
												class="fa-solid fa-arrow-trend-up ms-2"></i></a>
					...
					<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
						<div class="pop-touritem">
							<div class="card rounded-3 border m-0">
								<div class="flight-thumb-wrapper">
									<div class="popFlights-item-overHidden">
										<img src="assets/img/van_bnr-1.webp" class="img-fluid" alt="">
									</div>
								</div>
								<div class="touritem-middle position-relative p-3">
									<div class="touritem-flexxer">
										<div class="d-flex align-items-center justify-content-between">
											<h4 class="city fs-6 m-0 fw-bold">
												<span>van Rental India</span>
											</h4>
											<span class="city-rates"><i class="fa-solid fa-star text-warning me-1"></i><span
													class="fw-bold text-dark">4.8</span></span>
										</div>
										<div class="detail ellipsis-container mt-2">
											<p class="m-0 text-md">Travel to India is established travel company and expanding itself in the field of tourist transport service. Our vision is to.</p>
										</div>
							...
							<div class="card rounded-3 border m-0">
								...
								<div class="touritem-middle position-relative p-3">
									<div class="touritem-flexxer">
										<div class="d-flex align-items-center justify-content-between">
											<h4 class="city fs-6 m-0 fw-bold">
												<span>Bus Rental India</span>
											</h4>
											<span class="city-rates"><i class="fa-solid fa-star text-warning me-1"></i><span
													class="fw-bold text-dark">4.9</span></span>
										</div>
										<div class="detail ellipsis-container mt-2">
											<p class="m-0 text-md">We work with primary motive of comfort and enjoyment of travellers throughout the bus journey. You will feel safe while in.</p>
										</div>
					...
					<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
						<div class="pop-touritem">
							<div class="card rounded-3 border m-0">
								<div class="flight-thumb-wrapper">
									<div class="popFlights-item-overHidden">
										<img src="assets/img/swift-big@2x.webp" class="img-fluid" alt="">
									</div>
								</div>
								<div class="touritem-middle position-relative p-3">
									<div class="touritem-flexxer">
										<div class="d-flex align-items-center justify-content-between">
											<h4 class="city fs-6 m-0 fw-bold">
												<span>Car Rental India</span>
											</h4>
											<span class="city-rates"><i class="fa-solid fa-star text-warning me-1"></i><span
													class="fw-bold text-dark">4.7</span></span>
										</div>
										<div class="detail ellipsis-container mt-2">
											<p class="m-0 text-md">We are best car rental company in India offering car rental & cab rental services all over India. Our vision is to provide the.</p>
										</div>
		...
		<!-- ============================ Video Helps End ================================== -->
		<section class="bg-cover" style="background:url(assets/img/ghat.jpg)no-repeat;" data-overlay="5">
					...
					<div class="col-xl-12 col-lg-12 col-md-12">
						...
						<div class="video-play-wrap text-center">
							<div class="video-play-btn d-flex align-items-center justify-content-center">
								<a href="https://youtu.be/2lUkBy4UgLQ?si=ccGmBbWXXu_ecrKZ" data-bs-toggle="modal" data-bs-target="#popup-video" class="square--90 circle bg-white fs-2 text-primary"><i class="fa-solid fa-play"></i></a>
							</div>
						</div>
			...
			<div class="container">
				...
				<div class="row g-4 justify-content-between">
						...
						<div class="cardOffer cursor rounded-3 position-relative z-0">
							...
							<div class="cardOffer-content p-5">
								...
								<div class="d-flex mt-5">
									<a href="#" class="btn btn-whitener fw-medium px-5">Experiences<i class="fa-solid fa-arrow-trend-up ms-2"></i></a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-xl-6 col-lg-6 col-md-6 py-3">
						<div class="cardOffer cursor rounded-3 position-relative z-0">
							<div class="cardOffer-image ratio ratio-full">
								<img class="img-fluid object-fit" src="assets/img/discount-2.jpg" alt="image">
							</div>

							<div class="cardOffer-content p-5">
								<p class="text-light fw-medium m-0">Hot Summer Sale</p>
								<h4 class="fs-1 text-light">Upto Rs200 Discount</h4>
								<div class="d-inline-flex align-items-center justify-content-center py-2 px-4 cpnCode rounded-2">
			...
			<div class="container">
				...
				<div class="row justify-content-center g-4">
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
						<div class="blogGrid-wrap d-flex flex-column h-100">
							<div class="blogGrid-pics">
								<a href="{{url('blog-detail')}}" class="d-block"><img src="assets/img/blog-1.jpg" class="img-fluid rounded" alt="Blog image"></a>
							</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
						<div class="blogGrid-wrap d-flex flex-column h-100">
							<div class="blogGrid-pics">
								<a href="{{url('blog-detail')}}" class="d-block"><img src="assets/img/blog-2.jpg" class="img-fluid rounded" alt="Blog image"></a>
							</div>
							<div class="blogGrid-caps pt-3">
								<div class="d-flex align-items-center mb-1"><span
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
						<div class="blogGrid-wrap d-flex flex-column h-100">
							<div class="blogGrid-pics">
								<a href="{{url('blog-detail')}}" class="d-block"><img src="assets/img/blog-3.jpg" class="img-fluid rounded" alt="Blog image"></a>
							</div>
							<div class="blogGrid-caps pt-3">
								<div class="d-flex align-items-center mb-1"><span
		...
		<div class="position-relative bg-cover py-5 bg-primary mb-4" style="background:url(assets/img/bg.jpg)no-repeat;"
			data-overlay="5">
			<div class="container">
				<div class="row align-items-center justify-content-between">
					<div class="col-xl-12 col-lg-12 col-md-12">
						<div class="calltoAction-wraps position-relative py-5 px-4">
							<div class="ht-40"></div>
							<div class="row align-items-center justify-content-center">
								<div class=" col-lg-12 col-md-10 col-sm-11 text-center">
										...
										<form>
											<div class="row align-items-center justify-content-between bg-white rounded-3 p-2 gx-0">
												...
												<div class="col-lg-4 col-md-8">
													<div class="form-group m-0 newsbox">
												...
												<div class="col-lg-4 col-md-8">
													<div class="form-group m-0 newsbox">
														<input type="text" class="form-control bold ps-1 border-0" placeholder="Enter Your Phone Number!">
													</div>
												</div>
...
@endsection
<!-- Mirrored from themezhub.net/geotrip-live/geotrip/slider-home.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Jan 2024 08:21:35 GMT -->
</html>