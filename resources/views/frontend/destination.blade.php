					...
					<div class="col-xl-7 col-lg-9 col-md-12">
						...
						<div class="fpc-capstion text-center my-4">
							<div class="fpc-captions">
								<h1 class="xl-heading text-light">Search Your Destination</h1>
									...
									<div class="row gy-3 gx-md-3 gx-sm-2">
										<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 position-relative">
											<div class="form-group hdd-arrow mb-0">
												<label class="text-light text-uppercase opacity-75">Select City</label>
								...
								<div class="col-xl-4 col-lg-5 col-md-12">
									<div class="row align-items-end gy-3 gx-md-3 gx-sm-2">
										<div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
											<div class="form-group hdd-arrow mb-0">
												<label class="text-light text-uppercase opacity-75">Select Tour Type</label>
												...
												<option value="">Select Type</option>
															  ...
															  <option value="nl">Historical</option>
								...
								<div class="card list-layout-block rounded-3 p-3">
									<div class="row">
										...
										<div class="col-xl-4 col-lg-3 col-md">
											<a href="{{url('destinationdetail')}}">
											<div class="cardImage__caps rounded-2 overflow-hidden h-100">
												<img class="img-fluid h-100 object-fit" src="assets/img/attr/5c.jpg" alt="image">
											</div></a>
										</div>
										...
										<div class="col-xl col-lg col-md">
											<div class="listLayout_midCaps mt-md-0 mt-3 mb-md-0 mb-3">
												...
												<h4 class="fs-5 fw-bold mb-1">India Gate Walking Tour</h4>
												<ul class="row gx-2 p-0 excortio">
													<li class="col-auto">
														<p class="text-muted-2 text-md">
                                            A prominent landmark and a war memorial, India Gate is a must-visit attraction. It commemorates Indian soldiers who sacrificed their lives in World War I. Enjoy a leisurely stroll in the surrounding gardens.
                                              </p>
													</li>
													
												</ul>
												<div class="detail ellipsis-container mt-3">
													<a href="{{url('destinationdetail')}}"><span class="ellipsis">Read More</span></a>
