							...
							<div class="row g-0">
								...
								<div class="col-lg-6 order-1">
									<div class="p-3 p-sm-4 p-md-5">
										...
										<p class="mb-0">Are you new here?<a href="{{url('front-register')}}" class="fw-medium text-primary"> Create an
												account</a></p>

										<!-- Form START -->
										<form method="POST" action="{{ route('customer.login') }}" class="mt-4 text-start">
