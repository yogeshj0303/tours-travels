...
<div class="row">
                    ...
                    <div class="table-responsive table-card mb-1">
                        <table class="table table-nowrap align-middle" id="orderTable">
                            ...
                            <tbody class="list form-check-all">
                                @foreach($photo as $key => $temp)
                                <tr>
                                 
                                    <td class="id">{{++$key}}</td>
                                    <td class="gallery_location_id">{{$temp->gallery_location_id}}</td>
                                    <td class="gallery_photo">
    @if($temp->gallery_photo)
    <img src="{{ asset('gallery_images/' . $temp->gallery_photo) }}" alt="Gallery Photo" style="height: 100px; width: 100px;">
    ...
    @endif
        ...
        <a class="text-danger d-inline-block remove-item-btn delete-record" data-blog-id="{{ $temp->id }}" href="#">
                    ...
                    if (data.message === 'Gallery added successfully') {
                        ...
                        const newRow = `
                            <tr>
                                ...
                                <td class="gallery_photo">
                                    <img src="{{ asset('gallery_images/') }}/${data.gallery.gallery_photo}" alt="Gallery Photo" style="height: 100px; width: 100px;">
                                </td>
                                <td>
                                    <ul class="list-inline hstack gap-2 mb-0">
                                        <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
