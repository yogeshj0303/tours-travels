                        ...
                        <div class="col-md-4 mb-3">
                           ...
                           <select class="form-select form-select-md" name="district" id="districtSelect">
                              <option>-- select one -- </option>
                                                   ...
                                                   <div class="col-md-4 mb-3">
                           <label class="active">Cab Charge/ Month *</label>
                           <input name="name" type="text" class="form-control " required="" value="" placeholder="Rs 1000 / Cab">
                                                   </div>
