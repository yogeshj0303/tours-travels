                    ...
                    <div class="table-responsive table-card mb-1">
                        <table class="table table-nowrap align-middle" id="orderTable">
                            ...
                            <tbody class="list form-check-all">
                                @foreach($blogs as $key => $temp)
                                <tr>
                                 
                                    <td class="id"><a href="apps-ecommerce-order-details" class="fw-medium link-primary">#Blog{{++$key}}</a></td>
                                    <td class="customer_name">{{$temp->title}}</td>
                                    <td class="date">{{$temp->date_time}}</td>
                                    </td>
                                    <td>
